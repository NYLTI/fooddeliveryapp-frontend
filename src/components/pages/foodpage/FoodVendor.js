    ...
    return (
        <React.Fragment sx={{ '& > *': { borderBottom: 'unset', maxWidth: 100 } }}>
            <TableRow sx={{ '& > *': { borderBottom: 'unset', maxWidth: 1000 } }}>
                ...
                <TableCell align="center" sx={{ fontSize: 30, color: "#FFFFFF" }}>{row.name}</TableCell>
                <TableCell align="center"sx={{ fontSize: 30, color: "#FFFFFF" }}>{row.phoneNumber}</TableCell>
                <TableCell align="center" sx={{ fontSize: 30, color: "#FFFFFF" }}>{row.address}</TableCell>
                <TableCell align="center" sx={{ fontSize: 30, color: "#FFFFFF" }}>
                   ...
                   <input
                        ...
                        // style={{ align: "center" }}
                        style={{ visibility: ((currentUser !== null && !(currentUser === "LOGGEDOUT"))) ? 'visible' : 'hidden' }}
                        id={row.userName}
                        required
                    /><br />
                    <Button 
                    style={{ width:"40%", visibility: ((currentUser !== null && !(currentUser === "LOGGEDOUT"))) ? 'visible' : 'hidden' }}
                    // style={{ width: "40%" }}
                            ...
                            <Table size="small" aria-label="purchases">
                                <TableHead>
                                    <TableRow>
                                        ...
                                        <TableCell align="center" sx={{ fontSize: 30, color: "#FFFFFF" }}>Review Content</TableCell>
                                        <TableCell align="center" sx={{ fontSize: 30, color: "#FFFFFF" }}>Rating</TableCell>
                                    </TableRow>
                                </TableHead>
                                <TableBody>
                                    {(row.reviews).map((review) => (
                                        <TableRow key={review.id}>
                                            <TableCell align='center' sx={{ fontSize: 25, color: "#FFFFFF" }} >{review.reviewer}</TableCell>
                                            <TableCell align="center" sx={{ fontSize: 25, color: "#FFFFFF" }}>{review.body}</TableCell>
                                            <TableCell align="center" sx={{ fontSize: 25, color: "#FFFFFF" }}>
                                                <Rating 
                                                    name="read-only"
            ...
            <Table aria-label="collapsible table">
                <TableHead >
                    <TableRow>
                        ...
                        <TableCell align='center' sx={{ fontSize: 40, color: "#FFFFFF" }}>Phone Number</TableCell>
                        <TableCell align="center" sx={{ fontSize: 40, color: "#FFFFFF" }}>Address&nbsp;</TableCell>
